==============================================
simple custom vendor client demo
==============================================
...
* 节点上有两个custom vendor clent，可以通过手机单独配置client的pub/sub。


* 可以跟vendor server 配合，设置 client 的 publication 功能来控制server 的灯开关。
...
软件环境
********************************
* 设备端运行 ble mesh sdk 的 examples 目录下 simple_custom_vendor_client示例。
...
.. code:: c
    ...
    {
        ///user data init
        simple_custom_vendor_client_init();
